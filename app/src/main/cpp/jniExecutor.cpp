...
Java_com_yeolabgt_mahmoodms_eog2chdemo_DeviceControlActivity_jecgBandStopFilter(
...
extern "C" {
JNIEXPORT jdoubleArray JNICALL
Java_com_yeolabgt_mahmoodms_eog2chdemo_DeviceControlActivity_jdownSample(
 ...
 */
Java_com_yeolabgt_mahmoodms_eog2chdemo_DeviceControlActivity_jLoadfPSD(
...
Java_com_yeolabgt_mahmoodms_eog2chdemo_DeviceControlActivity_jecgFiltRescale(
        JNIEnv *env, jobject jobject1, jdoubleArray data) {
...
extern "C" {
JNIEXPORT jdoubleArray JNICALL
Java_com_yeolabgt_mahmoodms_eog2chdemo_DeviceControlActivity_jecgResample(
...
Java_com_yeolabgt_mahmoodms_eog2chdemo_DeviceControlActivity_jmainInitialization(
